...
export default function SinglePowerSupply({ data }) {
  const { _id, image, product_name, status, price, category, average_rating } =
    data;
  return (
    <Link
      href={`/category/power-supply-unit/${_id}`}
    ...
    >
      ...
      <div className="flex items-center justify-between mt-5 px-4 py-2 bg-red-500">

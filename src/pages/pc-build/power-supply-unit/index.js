...
import { addPowerSupply } from "@/redux/features/products/productSlice";
import Image from "next/image";
import Link from "next/link";
import { useDispatch } from "react-redux";

function PowerSupplyBuilder({ powerSupply }) {
  const dispatch = useDispatch();

  const handleAddToBuild = (powerSupply) => {
    dispatch(addPowerSupply(powerSupply));
  };
  return (
...
export default PowerSupplyBuilder;

PowerSupplyBuilder.getLayout = function getLayout(page) {

...
import { addProcessor } from "@/redux/features/products/productSlice";
import Image from "next/image";
import Link from "next/link";
import { useDispatch } from "react-redux";

function ProcessorBuilder({ processor }) {
  const dispatch = useDispatch();

  const handleAddToBuild = (processor) => {
...
ProcessorBuilder.getLayout = function getLayout(page) {
